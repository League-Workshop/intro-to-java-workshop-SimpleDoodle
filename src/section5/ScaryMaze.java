...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	private void touching(int background) {
	...
	private void scare() {
		...
		showScaryImage("nightmare.jpg");
	}

	private void showScaryImage(String nightmare) {
		try {
			maze = ImageIO.read(getClass().getResource(nightmare));
		} catch (Exception e) {
			System.err.println("Couldn't find this image: " + nightmare);
		}
		repaint();
	}
